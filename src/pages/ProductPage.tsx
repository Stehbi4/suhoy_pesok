  ...
  return (
    <main className="bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <section className="min-h-screen py-20 lg:py-32 flex items-center">
        <div className="w-full px-6 sm:px-10 lg:px-[1cm] grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="animate-on-scroll slide-in-left">
      ...
      <section className="relative py-32 bg-cover bg-center" style={{ backgroundImage: `url(${img.bg})` }}>
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        <div className="w-full px-6 sm:px-10 lg:px-[1cm] grid grid-cols-1 lg:grid-cols-2 gap-12 h-full items-center">
      ...
      <section className="h-screen flex items-center bg-black">
        <div className="w-full px-6 sm:px-10 lg:px-[1cm] text-center animate-on-scroll animation-delay-200">
          <Link
            to="/catalog"
