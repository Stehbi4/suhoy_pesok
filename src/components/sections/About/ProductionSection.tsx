...
const ProductionSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-brand-graphite relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -right-3 w-20 h-20 border-r-2 border-b-2 border-brand-red" />
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-4 -right-4 bg-brand-red text-white p-5 rounded-lg">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              ...
              и доводим его до совершенства. <span className="text-3xl text-brand-red font-medium"> Наш многолетний опыт </span> лабораторных испытаний 
              и разработки высокотехнологичных ремонтных материалов для бетона позволил 
              нам создать собственную линию сухого кварцевого песка <span className="text-3xl text-brand-red font-medium"> с исключительными характеристиками</span>. 
            </p>           
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 p-3 rounded-lg bg-brand-bg border border-[#222] card-hover hover:border-brand-red/30"
                >
