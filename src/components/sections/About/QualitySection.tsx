        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              ...
              которая более <span className="text-3xl text-brand-red font-medium">20</span> лет работает с самыми требовательными задачами строительной химии.<br />
          ...
          <div className="relative">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -left-3 w-20 h-20 border-l-2 border-b-2 border-brand-red" />
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-4 -left-4 bg-brand-red text-white p-5 rounded-lg">
